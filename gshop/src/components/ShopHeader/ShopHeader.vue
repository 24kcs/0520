<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.name" @click="isShowSupports=!isShowSupports">
    ...
    <transition name="move">
      <div class="activity-sheet" v-show="isShowSupports">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li
              class="activity-item" :class="supportsClass[support.type]"
...
export default {
  data() {
    return {
      isShowBulletin: false, // 商家信息的显示和隐藏的状态,false,默认不显示
      isShowSupports: false, // 活动信息的显示和隐藏的状态,false,默认不显示
